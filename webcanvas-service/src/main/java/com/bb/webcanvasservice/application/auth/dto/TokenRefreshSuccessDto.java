package com.bb.webcanvasservice.application.auth.dto;

import io.swagger.v3.oas.annotations.media.Schema;

@Schema(description = "Application Layer token refresh success dto")
public record TokenRefreshSuccessDto(
