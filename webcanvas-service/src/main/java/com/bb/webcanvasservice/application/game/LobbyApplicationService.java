...
import com.bb.webcanvasservice.domain.game.service.GameRoomEntranceService;
...
public class LobbyApplicationService {
     ...
     * 도메인 서비스
     */
    private final GameRoomEntranceService gameRoomEntranceService;
    ...
    public Long createGameRoom(Long userId) {
         ...
         */
        gameRoomEntranceService.checkCanEnterTheRoom(userId);
