...
//
//        UserJpaEntity alreadyEnteredUser1JpaEntity = new UserJpaEntity(UUID.randomUUID().toString());
//        UserJpaEntity alreadyEnteredUser2JpaEntity = new UserJpaEntity(UUID.randomUUID().toString());
//
//
//        // 테스트 유저
//        UserJpaEntity testUser = new UserJpaEntity(testUserToken);
...
//        GameRoomEntrance hostEntrance = new GameRoomEntrance(testGameRoom, new UserJpaEntity(1L, UUID.randomUUID().toString(), "refreshToekn0", UserStateCode.IN_LOBBY), "nickname", HOST);
//        entrances.add(hostEntrance);
//        setId(hostEntrance, 0L);
//        for (int i = 1; i < 8; i++) {
//            GameRoomEntrance guestEntrance = new GameRoomEntrance(testGameRoom, new UserJpaEntity((long) i, UUID.randomUUID().toString(), "refreshToekn" + i, UserStateCode.IN_LOBBY), "nickname", GUEST);
...
//        setId(gameRoom, 1L);
//
//        UserJpaEntity user1 = new UserJpaEntity(1L, UUID.randomUUID().toString(), "refreshToekn1", UserStateCode.IN_LOBBY);
//        UserJpaEntity user2 = new UserJpaEntity(2L, UUID.randomUUID().toString(), "refreshToekn2", UserStateCode.IN_LOBBY);
//        UserJpaEntity user3 = new UserJpaEntity(3L, UUID.randomUUID().toString(), "refreshToekn3", UserStateCode.IN_LOBBY);
//        UserJpaEntity user4 = new UserJpaEntity(4L, UUID.randomUUID().toString(), "refreshToekn4", UserStateCode.IN_LOBBY);
//
//        setId(user1, 1L);
//        setId(user2, 2L);
//        setId(user3, 3L);
...
//        var testUser0 = new UserJpaEntity(0L, UUID.randomUUID().toString(), "refreshToekn0", UserStateCode.IN_LOBBY);
//        var testUser1 = new UserJpaEntity(1L, UUID.randomUUID().toString(), "refreshToekn1", UserStateCode.IN_LOBBY);
//        var testUser2 = new UserJpaEntity(2L, UUID.randomUUID().toString(), "refreshToekn2", UserStateCode.IN_LOBBY);
...
//        var testUser = new User(0L, UUID.randomUUID().toString(), "refreshToekn1");
